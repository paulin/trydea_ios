...
+(id)loadingViewInView:(UIView *)aSuperview withLabel:(NSString *)label
{
	...
	[[[UILabel alloc]
	 ...
	 autorelease];
	loadingLabel.text = NSLocalizedString(label, nil);
...
- (void)drawRect:(CGRect)rect
{
	...
	const CGFloat RECT_PADDING = 1.0;
	...
	const CGFloat BACKGROUND_OPACITY = 0.35;
